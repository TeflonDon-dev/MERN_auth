...
import { deleteUserFailure, deleteUserStart, deleteUserSuccess, signInFailure, signOut, updateUserFailure, updateUserStart, updateUserSuccess } from '../redux/user/userSlice';
  ...
  return (
    <div className=' p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className=' flex flex-col gap-4' >
        <input onChange={(e)=>setImage(e.target.files[0])} hidden type="file"  accept='image/*' ref={fileRef} />
        <img onClick={()=>fileRef.current.click()} className=' h-24 w-24 self-center cursor-pointer rounded-full object-cover mt-2' src={formData.profilePicture || currentUser.profilePicture} alt="profileImage" />
